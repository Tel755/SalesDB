...
namespace SalesManagement.SalesDBDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([ItemID] = @Original_ItemID) AND ((@IsNull_Item" +
                "Name = 1 AND [ItemName] IS NULL) OR ([ItemName] = @Original_ItemName)) AND ((@Is" +
                "Null_ItemPrice = 1 AND [ItemPrice] IS NULL) OR ([ItemPrice] = @Original_ItemPric" +
                "e)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ItemName] = @ItemName, [ItemPrice] = @ItemPrice WHERE (([ItemID] = @Original_ItemID) AND ((@IsNull_ItemName = 1 AND [ItemName] IS NULL) OR ([ItemName] = @Original_ItemName)) AND ((@IsNull_ItemPrice = 1 AND [ItemPrice] IS NULL) OR ([ItemPrice] = @Original_ItemPrice)));
SELECT ItemID, ItemName, ItemPrice FROM Items WHERE (ItemID = @ItemID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SalesManagement.Properties.Settings.Default.SalesDBConnectionString;
        }
        ...
        public virtual int Fill(SalesDBDataSet.ItemsDataTable dataTable) {
        ...
        public virtual SalesDBDataSet.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SalesDBDataSet.ItemsDataTable dataTable = new SalesDBDataSet.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SalesDBDataSet.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ItemID, string Original_ItemName, global::System.Nullable<decimal> Original_ItemPrice) {
        ...
        public virtual int Insert(string ItemName, global::System.Nullable<decimal> ItemPrice) {
            if ((ItemName == null)) {
            ...
            if ((ItemPrice.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((decimal)(ItemPrice.Value));
            }
            else {
        ...
        public virtual int Update(string ItemName, global::System.Nullable<decimal> ItemPrice, int Original_ItemID, string Original_ItemName, global::System.Nullable<decimal> Original_ItemPrice, int ItemID) {
            if ((ItemName == null)) {
            ...
            if ((ItemPrice.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((decimal)(ItemPrice.Value));
            }
            else {
            ...
            if ((Original_ItemPrice.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((decimal)(Original_ItemPrice.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ItemName, global::System.Nullable<decimal> ItemPrice, int Original_ItemID, string Original_ItemName, global::System.Nullable<decimal> Original_ItemPrice) {
